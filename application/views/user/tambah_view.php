                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="lahir" required="required" placeholder="Contoh : Surakarta">
                                </div>
                                <div class="form-group">
                                    <label>Tanggal Lahir</label>
                                    <input type="date" class="form-control" name="tgl_lahir" required="required" placeholder="Contoh : 2003-02-14">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <option>Petugas atau Admin</option>
                                    <option>Anggota atau User</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label>Telepon</label>
                                    <input id="uintTextBox" class="form-control" name="telepon" required="required" placeholder="Contoh : 089515454702">
                                </div>
                                <div class="form-group">
                                    <label>E-mail</label>
                                    <input type="email" class="form-control" name="email" required="required" placeholder="Contoh : admin@gmail.com">
                                </div>
                                <div class="form-group">
                                    <label>Pas Foto <small style="color:green">(jpg/png)</small></label>
