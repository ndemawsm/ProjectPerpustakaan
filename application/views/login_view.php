...
<body class="hold-transition login-page" style="overflow-y: hidden;background:url(
	'<?php echo base_url('assets_style/image/brary.jpg');?>')no-repeat;background-size:100%;">
<div class="login-box">
	<br/>
  <div class="login-logo">
    <a href="index.php" style="color: #FFD700;">Selamat Datang Di <br/><b>Perpustakaan</b></a>
  </div>
  <div id="tampilalert"></div>
  <!-- /.login-logo -->
  <div class="login-box-body" style="border:2px solid orange;">
    ...
    <form action="<?= base_url('login/auth');?>" method="POST">
      ...
      <div class="row">
        ...
        <div class="col-xs-4">
          <button type="submit" id="loding" class="btn btn-info btn-block btn-flat">Login</button>
  ...
  <footer>
    <div class="login-box-body text-center bg-orange">
       <a style="color: White;"> Copyright &copy; Sistem Perpustakaan Nikolas.P - <?php echo date("Y");?>
    </div>
  </footer>
</div>
<!-- /.login-box -->
